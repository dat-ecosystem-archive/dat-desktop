...
module.exports = class Manager extends EventEmitter {
  ...
  _activate (dat) {
    Object.defineProperty(dat, 'progress', {
      get: () => {
        ...
        if (dat.archive) {
          progress += dat.archive.metadata.blocks - dat.archive.metadata.blocksRemaining()
          total += dat.archive.metadata.blocks
        }
        if (stats) {
          progress += stats.blocksProgress
          total += stats.blocksTotal
        }
        // https://github.com/datproject/dat-desktop/pull/174#discussion_r98008412
