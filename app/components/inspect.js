...
const Inspect = ({ dat, closeInspectDat, addFilesToDat }) => {
  ...
  const title = dat
    ...
    : 'Fetching metadata …'
  const author = dat
    ? dat.metadata && dat.metadata.author
    ? dat.metadata.author
    : 'N/A'
    : '…'
  const description = dat
    ...
    : 'N/A'
    : '…'
  const size = Number(dat.stats.length) == dat.stats.length
      ...
      <div className="flex flex-column flex-auto">
        ...
        <div className="flex-auto pa3 pl5 bg-neutral-04 overflow-y-auto">
          ...
          <div className="flex">
            ...
            <div className="is-selectable f7 f6-l mb2 mw6">
              {size}
            </div>
          </div>
          <div className="flex">
